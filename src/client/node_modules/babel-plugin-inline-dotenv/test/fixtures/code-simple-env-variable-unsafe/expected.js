...
const EXAMPLE_ENV_VAR = "simple example";
const EXAMPLE_ENV_VAR_EXPAND = "simple example-expand";
const EXAMPLE_ENV_VAR_SECRET = undefined;
const EXAMPLE_ENV_VAR_SYSTEM = "system";
