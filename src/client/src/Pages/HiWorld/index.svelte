...
<div class="az-content az-content-dashboard-two">
    ...
    <div class="az-content-header d-block d-md-flex">
      <div>
        <h2 class="az-content-title tx-24 mg-b-5 mg-b-lg-8">Hi, This is from Hi World Component</h2>
        <p class="mg-b-0">This is the props from Inertia <span>{username}</span></p>
      </div>
